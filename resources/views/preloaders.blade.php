        ...
        <section id="main">
            <aside id="notifications">
                <ul class="tab-nav tab-nav--justified tab-nav--icon">
                    <li><a class="user-alert__messages" href="preloaders.html#notifications__messages" data-toggle="tab"><i class="zmdi zmdi-email"></i></a></li>
                    <li><a class="user-alert__notifications" href="preloaders.html#notifications__updates" data-toggle="tab"><i class="zmdi zmdi-notifications"></i></a></li>
                    <li><a class="user-alert__tasks" href="preloaders.html#notifications__tasks" data-toggle="tab"><i class="zmdi zmdi-playlist-plus"></i></a></li>
                </ul>
                    ...
                    <ul>
                        ...
                        <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                            ...
                            <ul>
                                ...
                                <li class="navigation__active"><a href="preloaders.html">Preloaders</a></li>
            ...
            <section id="content">
                <div class="container">
                    <div class="content__header">
                        <h2>Preloaders <small>Material Design Preloaders based on CSS and SVG</small></h2>
                    ...
                    <div class="card">
                        <div class="card__header">
                            <h2>Basic Example <small>Preloaders are available in multiple color variants.</small></h2>
                        </div>
                        ...
                        <div class="card__body">
                            ...
                            <div class="preloader preloader--red">
                                <svg viewBox="25 25 50 50">
                                    <circle cx="50" cy="50" r="20" />
                                </svg>
                            </div>

                            <div class="preloader preloader--blue">
                                <svg viewBox="25 25 50 50">
                                    <circle cx="50" cy="50" r="20"/>
                                </svg>
                            </div>

                            <div class="preloader preloader--green">
                                <svg viewBox="25 25 50 50">
                                    <circle cx="50" cy="50" r="20" />
                                </svg>
                            </div>

                            <div class="preloader preloader--yellow">
                                <svg viewBox="25 25 50 50">
                                    <circle cx="50" cy="50" r="20" />
                                </svg>
                            </div>

                            <div class="preloader preloader--bluegray">
                                <svg viewBox="25 25 50 50">
                                    <circle cx="50" cy="50" r="20" />
                                </svg>
                            </div>

                            <div class="preloader preloader--amber">
                                <svg viewBox="25 25 50 50">
                                    <circle cx="50" cy="50" r="20" />
                                </svg>
                            </div>

                            <div class="preloader preloader--teal">
                                <svg viewBox="25 25 50 50">
                                    <circle cx="50" cy="50" r="20" />
                                </svg>
                            </div>

                            <div class="preloader preloader--pink">
                                <svg viewBox="25 25 50 50">
                                    <circle cx="50" cy="50" r="20" />
                                </svg>
                            </div>

                            <div class="preloader preloader--purple">
                                <svg viewBox="25 25 50 50">
                                    <circle cx="50" cy="50" r="20" />
                                </svg>
                            </div>
                    ...
                    <div class="card">
                        <div class="card__header">
                            <h2>Sizing <small>Preloaders are also available in 4 custom sizes.</small></h2>
                        </div>

                        <div class="card__body">
                            <div class="preloader preloader--sm preloader--light">
                                <svg viewBox="25 25 50 50">
                                    <circle cx="50" cy="50" r="20" />
                                </svg>
                            </div>
                            ...
                            <div class="preloader preloader--lg preloader--light">
                                <svg viewBox="25 25 50 50">
                                    <circle cx="50" cy="50" r="20" />
                                </svg>
                            </div>
