        ...
        <section id="main">
            <aside id="notifications">
                <ul class="tab-nav tab-nav--justified tab-nav--icon">
                    <li><a class="user-alert__messages" href="calendar.html#notifications__messages" data-toggle="tab"><i class="zmdi zmdi-email"></i></a></li>
                    <li><a class="user-alert__notifications" href="calendar.html#notifications__updates" data-toggle="tab"><i class="zmdi zmdi-notifications"></i></a></li>
                    <li><a class="user-alert__tasks" href="calendar.html#notifications__tasks" data-toggle="tab"><i class="zmdi zmdi-playlist-plus"></i></a></li>
                </ul>
            ...
            <aside id="navigation">
                ...
                <div class="navigation__menu c-overflow">
                    <ul>
                        ...
                        <li class="navigation__active"><a href="calendar.html"><i class="zmdi zmdi-calendar"></i> Calendar</a></li>
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                <form class="edit-event__form">
                                    ...
                                    <div class="form-group form-group--light">
                                        <textarea class="form-control edit-event__description textarea-autoheight" placeholder="Event Desctiption"></textarea>
                                        <i class="form-group__bar"></i>
                                    </div>
