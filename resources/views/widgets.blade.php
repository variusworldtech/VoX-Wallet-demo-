        ...
        <section id="main">
            ...
            <aside id="navigation">
                ...
                <div class="navigation__menu c-overflow">
                    <ul>
                        ...
                        <li class="navigation__active"><a href="widgets.html"><i class="zmdi zmdi-widgets"></i> Widgets</a></li>
            ...
            <section id="content">
                ...
                <div id="content__grid" data-columns>
                    ...
                    <div class="card">
                        <div class="card__header">
                            <h2>Ongoing Tasks <small>Maecenas seddiam eget risusvarius blandit</small></h2>
                        ...
                        <div class="list-group">
                            ...
                            <div class="list-group__empty"></div>
                        </div>
                    </div>
                    ...
                    <div class="card widget-weather">
                        ...
                        <div id="widget-weather__main"></div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <ul class="tab-nav tab-nav--justified tab-nav--icon">
                            <li class="active">
                                <a class="col-sx-4" href="widgets.html#tab-1" data-toggle="tab">
                                    <i class="zmdi zmdi-home icon-tab"></i>
                                </a>
                            </li>
                            <li>
                                <a class="col-xs-4" href="widgets.html#tab-2" data-toggle="tab">
                                    <i class="zmdi zmdi-pin icon-tab"></i>
                                </a>
                            </li>
                            <li>
                                <a class="col-xs-4" href="widgets.html#tab-3" data-toggle="tab">
                        ...
                        <div class="card__body">
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="tab-1">
                                    <p><img src="demo/img/headers/sm/6.png" class="img-responsive" alt=""></p>
                                ...
                                <div class="tab-pane fade" id="tab-2">
                                    <p><img src="demo/img/headers/sm/2.png" class="img-responsive" alt=""></p>
                                ...
                                <div class="tab-pane fade" id="tab-3">
                                    <p><img src="demo/img/headers/sm/4.png" class="img-responsive" alt=""></p>
                    ...
                    <div class="card widget-profile">
                        <div class="card__header card__header--highlight text-center">
                            ...
                            <button class="btn btn--float"><i class="zmdi zmdi-email"></i></button>
                        </div>
                        ...
                        <div class="list-group list-group--striped">
                            ...
                            <div class="list-group-item media">
                                ...
                                <div class="media-body">
                                    <div class="list-group__heading">@m-hollaway</div>
                                    <small class="list-group__text">Twitter</small>
                                </div>
                            </div>
                            <div class="list-group-item media">
                                <div class="pull-left">
                                ...
                                <div class="media-body">
                                    <div class="list-group__heading">facebook/hollaway</div>
                                    <small class="list-group__text">Facebook</small>
                                </div>
                            </div>
                            <div class="list-group-item media">
                                <div class="pull-left">
                                ...
                                <div class="media-body">
                                    <div class="list-group__heading">github.com/hollaway</div>
                                    <small class="list-group__text">Github</small>
                                </div>
                            </div>
                        </div>
                    </div>
