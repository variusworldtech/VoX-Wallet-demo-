        ...
        <section id="main">
            <aside id="notifications">
                <ul class="tab-nav tab-nav--justified tab-nav--icon">
                    <li><a class="user-alert__messages" href="pricing-table.html#notifications__messages" data-toggle="tab"><i class="zmdi zmdi-email"></i></a></li>
                    <li><a class="user-alert__notifications" href="pricing-table.html#notifications__updates" data-toggle="tab"><i class="zmdi zmdi-notifications"></i></a></li>
                    <li><a class="user-alert__tasks" href="pricing-table.html#notifications__tasks" data-toggle="tab"><i class="zmdi zmdi-playlist-plus"></i></a></li>
                </ul>
                    ...
                    <ul>
                        ...
                        <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                            ...
                            <ul>
                                ...
                                <li class="navigation__active"><a href="pricing-table.html">Pricing Table</a></li>
            ...
            <section id="content">
                <div class="content--boxed">
                    <div class="content__header">
                        <h2>Payment Made Simple <small>Cras pretium elementum lacus ac auctor. Sed id mi nec ex placerat iaculis.</small></h2>
                    </div>
                    ...
                    <div class="row pricing-table">
                        <div class="col-sm-4">
                            <div class="pricing-table__item">
                                ...
                                <div class="pricing-table__name">Apple Pack</div>
                                ...
                                <div class="pricing-table__footer">
                                    <a href=""><i class="zmdi zmdi-check"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="pricing-table__item">
                                ...
                                <div class="pricing-table__name">Orange Pack</div>
                        ...
                        <div class="col-sm-4">
                            <div class="pricing-table__item">
                                ...
                                <div class="pricing-table__name">Banana Pack</div>
