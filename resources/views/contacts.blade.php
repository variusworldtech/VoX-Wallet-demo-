        ...
        <section id="main">
            <aside id="notifications">
                <ul class="tab-nav tab-nav--justified tab-nav--icon">
                    <li><a class="user-alert__messages" href="contacts.html#notifications__messages" data-toggle="tab"><i class="zmdi zmdi-email"></i></a></li>
                    <li><a class="user-alert__notifications" href="contacts.html#notifications__updates" data-toggle="tab"><i class="zmdi zmdi-notifications"></i></a></li>
                    <li><a class="user-alert__tasks" href="contacts.html#notifications__tasks" data-toggle="tab"><i class="zmdi zmdi-playlist-plus"></i></a></li>
                </ul>
                    ...
                    <ul>
                        ...
                        <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                            ...
                            <ul>
                                ...
                                <li class="navigation__active"><a href="contacts.html">Contacts</a></li>
                    ...
                    <div class="contacts row">
                        <div class="col-md-2 col-sm-4">
                            <div class="contacts__item">
                                ...
                                <button class="contacts__btn btn btn--icon-text btn--light"><i class="zmdi zmdi-account-add"></i> Add</button>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <div class="contacts__item">
                                <a href="" class="contacts__img">
                                    <img src="demo/img/contacts/3.jpg" alt="">
                                </a>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <div class="contacts__item">
                                <a href="" class="contacts__img">
                                    <img src="demo/img/contacts/4.jpg" alt="">
                                </a>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <div class="contacts__item">
                                <a href="" class="contacts__img">
                                    <img src="demo/img/contacts/5.jpg" alt="">
                                </a>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <div class="contacts__item">
                                <a href="" class="contacts__img">
                                    <img src="demo/img/contacts/6.jpg" alt="">
                                </a>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <div class="contacts__item">
                                <a href="" class="contacts__img">
                                    <img src="demo/img/contacts/7.jpg" alt="">
                                </a>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <div class="contacts__item">
                                <a href="" class="contacts__img">
                                    <img src="demo/img/contacts/8.jpg" alt="">
                                </a>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <div class="contacts__item">
                                <a href="" class="contacts__img">
                                    <img src="demo/img/contacts/10.jpg" alt="">
                                </a>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <div class="contacts__item">
                                <a href="" class="contacts__img">
                                    <img src="demo/img/contacts/11.jpg" alt="">
                                </a>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <div class="contacts__item">
                                <a href="" class="contacts__img">
                                    <img src="demo/img/contacts/12.jpg" alt="">
                                </a>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <div class="contacts__item">
                                <a href="" class="contacts__img">
                                    <img src="demo/img/contacts/13.jpg" alt="">
                                </a>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <div class="contacts__item">
                                <a href="" class="contacts__img">
                                    <img src="demo/img/contacts/14.jpg" alt="">
                                </a>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <div class="contacts__item">
                                <a href="" class="contacts__img">
                                    <img src="demo/img/contacts/15.jpg" alt="">
                                </a>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <div class="contacts__item">
                                <a href="" class="contacts__img">
                                    <img src="demo/img/contacts/16.jpg" alt="">
                                </a>
