        ...
        <section id="main">
            <aside id="notifications">
                <ul class="tab-nav tab-nav--justified tab-nav--icon">
                    <li><a class="user-alert__messages" href="media.html#notifications__messages" data-toggle="tab"><i class="zmdi zmdi-email"></i></a></li>
                    <li><a class="user-alert__notifications" href="media.html#notifications__updates" data-toggle="tab"><i class="zmdi zmdi-notifications"></i></a></li>
                    <li><a class="user-alert__tasks" href="media.html#notifications__tasks" data-toggle="tab"><i class="zmdi zmdi-playlist-plus"></i></a></li>
                </ul>
                    ...
                    <ul>
                        ...
                        <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                            ...
                            <ul>
                                ...
                                <li class="navigation__active"><a href="media.html">Media</a></li>
                    ...
                    <div class="card__body">
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-md-2">
                                <a href="media.html#" class="thumbnail">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        ...
                                        <a href="media.html#" class="btn btn-sm btn-default" role="button">Button</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-3">
                ...
                <div class="card">
                    ...
                    <div class="card__body">
                        ...
                        <div class="lightbox row">
                            <div data-src="demo/img/gallery/1.jpg" class="col-sm-2 col-xs-6">
                                <div class="lightbox__item">
                                    <img src="demo/img/gallery/thumbs/1.jpg" alt="" />
                                </div>
                            </div>

                            <div data-src="demo/img/gallery/2.jpg" class="col-sm-2 col-xs-6" data-sub-html="<em><h3>This is a caption heading</h3><p>Here goes the description...</p></em>">
                                <div class="lightbox__item">
                                    <img src="demo/img/gallery/thumbs/2.jpg" alt=""  />
                                </div>
                            </div>

                            <div data-src="demo/img/gallery/3.jpg" class="col-sm-2 col-xs-6">
                                <div class="lightbox__item">
                                    <img src="demo/img/gallery/thumbs/3.jpg" alt=""  />
                                </div>
                            </div>

                            <div data-src="demo/img/gallery/4.jpg" class="col-sm-2 col-xs-6" data-sub-html="<em><h3>This is a caption heading</h3><p>Here goes the description...</p></em>">
                                <div class="lightbox__item">
                                    <img src="demo/img/gallery/thumbs/4.jpg" alt=""  />
                                </div>
                            </div>

                            <div data-src="demo/img/gallery/5.jpg" class="col-sm-2 col-xs-6">
                                <div class="lightbox__item">
                                    <img src="demo/img/gallery/thumbs/5.jpg" alt=""  />
                                </div>
                            </div>

                            <div data-src="demo/img/gallery/1.jpg" class="col-sm-2 col-xs-6" data-sub-html="<em><h3>This is a caption heading</h3><p>Here goes the description...</p></em>">
                                <div class="lightbox__item">
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img src="demo/img/carousel/c-1.jpg" alt="">
                                ...
                                <div class="item">
                                    <img src="demo/img/carousel/c-2.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img src="demo/img/carousel/c-3.jpg" alt="">
                                </div>
                            </div>

                            <!-- Controls -->
                            <a class="left carousel-control" href="media.html#carousel-example-generic" data-slide="prev">
                                <span class="zmdi zmdi-chevron-left"></span>
                            </a>
                            <a class="right carousel-control" href="media.html#carousel-example-generic" data-slide="next">
