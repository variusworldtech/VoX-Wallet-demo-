        ...
        <section id="main">
            <aside id="notifications">
                <ul class="tab-nav tab-nav--justified tab-nav--icon">
                    <li><a class="user-alert__messages" href="notification-dialog.html#notifications__messages" data-toggle="tab"><i class="zmdi zmdi-email"></i></a></li>
                    <li><a class="user-alert__notifications" href="notification-dialog.html#notifications__updates" data-toggle="tab"><i class="zmdi zmdi-notifications"></i></a></li>
                    <li><a class="user-alert__tasks" href="notification-dialog.html#notifications__tasks" data-toggle="tab"><i class="zmdi zmdi-playlist-plus"></i></a></li>
                </ul>
                    ...
                    <ul>
                        ...
                        <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                            ...
                            <ul>
                                ...
                                <li class="navigation__active"><a href="notification-dialog.html">Notifications & Dialogs</a></li>
                    ...
                    <div class="card__body">
                        ...
                        <div class="notifications row">
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light" data-from="top" data-align="left" data-icon="fa fa-check">Top Left</a>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light"  data-from="top" data-align="right" data-icon="fa fa-comments">Top Right</a>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light"  data-from="top" data-align="center" data-icon="fa fa-comments">Top Center</a>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light"  data-from="bottom" data-align="left">Bottom Left</a>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light"  data-from="bottom" data-align="right">Bottom Right</a>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light"  data-from="bottom" data-align="center">Bottom Center</a>
                            </div>
                        </div>
                        ...
                        <div class="notifications row">
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light">Default (alert--light)</a>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                        ...
                        <div class="notifications row">
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light" data-animation-in="animated fadeIn"  data-animation-Out="animated fadeOut">Fade In</a>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light" data-animation-in="animated fadeInLeft"  data-animation-Out="animated fadeOutLeft">Fade In Left</a>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light" data-animation-in="animated fadeInRight"  data-animation-Out="animated fadeOutRight">Fade In Right</a>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light" data-animation-in="animated fadeInUp"  data-animation-Out="animated fadeOutUp">Fade In Up</a>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light" data-animation-in="animated fadeInDown"  data-animation-Out="animated fadeOutDown">Fade In Down</a>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light" data-animation-in="animated bounceIn"  data-animation-Out="animated bounceOut">Bounce In</a>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light" data-animation-in="animated bounceInLeft"  data-animation-Out="animated bounceOutLeft">Bounce In Left</a>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light" data-animation-in="animated bounceInRight"  data-animation-Out="animated bounceOutRight">Bounce In Right</a>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light" data-animation-in="animated bounceInUp"  data-animation-Out="animated bounceOutUp">Bounce In Up</a>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light" data-animation-in="animated rotateInDownRight"  data-animation-Out="animated rotateOutUpRight">Fall In Right</a>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light" data-animation-in="animated rotateIn"  data-animation-Out="animated rotateOut">Rotate In</a>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light" data-animation-in="animated flipInX"  data-animation-Out="animated flipOutX">Flip In X</a>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <a href="" class="btn btn--light" data-type="-light" data-animation-in="animated flipInY"  data-animation-Out="animated flipOutY">Flip In Y</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card__body">
                        <div class="row">
                            <div class="col-sm-3 m-b-30">
                                ...
                                <button class="btn btn--light" id="sa-basic">Click me</button>
                            </div>

                            <div class="col-sm-3 m-b-30">
                                <p>A title with a text under</p>

                                <button class="btn btn--light" id="sa-title">Click me</button>
                            </div>

                            <div class="col-sm-3 m-b-30">
                                <p>A success message!</p>

                                <button class="btn btn--light" id="sa-success">Click me</button>
                            </div>

                            <div class="col-sm-3 m-b-30">
                                <p>A Warning message!</p>

                                <button class="btn btn--light" id="sa-warning">Click me</button>
                            </div>

                            <div class="col-sm-3 m-b-30">
                                <p>Question</p>

                                <button class="btn btn--light" id="sa-question">Click me</button>
                            </div>

                            <div class="col-sm-3 m-b-30">
                                <p>A warning message, with a function attached to the "Confirm" button</p>

                                <button class="btn btn--light" id="sa-function">Click me</button>
                            </div>

                            <div class="col-sm-3 m-b-30">
                                <p>A message with custom Image Header</p>

                                <button class="btn btn--light" id="sa-image">Click me</button>
                            </div>

                            <div class="col-sm-3 m-b-30">
                                <p>A message with auto close timer</p>

                                <button class="btn btn--light" id="sa-close">Click me</button>
                            </div>
                        </div>
                    </div>
                </div>
