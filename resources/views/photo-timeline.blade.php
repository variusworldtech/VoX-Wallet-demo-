        ...
        <section id="main">
            <aside id="notifications">
                <ul class="tab-nav tab-nav--justified tab-nav--icon">
                    <li><a class="user-alert__messages" href="photo-timeline.html#notifications__messages" data-toggle="tab"><i class="zmdi zmdi-email"></i></a></li>
                    <li><a class="user-alert__notifications" href="photo-timeline.html#notifications__updates" data-toggle="tab"><i class="zmdi zmdi-notifications"></i></a></li>
                    <li><a class="user-alert__tasks" href="photo-timeline.html#notifications__tasks" data-toggle="tab"><i class="zmdi zmdi-playlist-plus"></i></a></li>
                </ul>
                    ...
                    <ul>
                        ...
                        <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                            ...
                            <ul>
                                ...
                                <li class="navigation__active"><a href="photo-timeline.html">Timeline</a></li>
                            </ul>
                        </li>
                ...
                <div class="card">
                    ...
                    <div class="card__body">
                        <div class="photos-timeline">
                            <div class="photos-timeline__date">
                                <span>2015</span>
                                05/08
                            </div>

                            <div class="photos-timeline__body">
                                <h2 class="photos-timeline__title">Mallinda's Collection</h2>

                                <div class="lightbox">
                                    <div data-src="demo/img/gallery/1.jpg">
                                        <div class="lightbox__item">
                                            <img src="demo/img/gallery/thumbs/1.jpg" alt="" />
                                        </div>
                                    </div>

                                    <div data-src="demo/img/gallery/2.jpg">
                                        <div class="lightbox__item">
                                            <img src="demo/img/gallery/thumbs/2.jpg" alt="" />
                                        </div>
                                    </div>

                                    <div data-src="demo/img/gallery/3.jpg">
                                        <div class="lightbox__item p-item">
                                            <img src="demo/img/gallery/thumbs/3.jpg" alt="" />
                                        </div>
                                    </div>

                                    <div data-src="demo/img/gallery/4.jpg">
                                        <div class="lightbox__item p-item">
                                            <img src="demo/img/gallery/thumbs/4.jpg" alt="" />
                                        </div>
                                    </div>

                                    <div data-src="demo/img/gallery/5.jpg">
                                        <div class="lightbox__item p-item">
                                            <img src="demo/img/gallery/thumbs/5.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/6.jpg">
                                        <div class="lightbox__item p-item">
                                            <img src="demo/img/gallery/thumbs/6.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/7.jpg">
                                        <div class="lightbox__item p-item">
                                            <img src="demo/img/gallery/thumbs/7.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/8.jpg">
                                        <div class="lightbox__item p-item">
                                            <img src="demo/img/gallery/thumbs/8.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/9.jpg">
                                        <div class="lightbox__item p-item">
                                            <img src="demo/img/gallery/thumbs/9.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/10.jpg">
                                        <div class="lightbox__item p-item">
                                            <img src="demo/img/gallery/thumbs/10.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/11.jpg">
                                        <div class="lightbox__item p-item">
                                            <img src="demo/img/gallery/thumbs/11.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/12.jpg">
                                        <div class="lightbox__item p-item">
                                            <img src="demo/img/gallery/thumbs/12.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/13.jpg">
                                        <div class="lightbox__item p-item">
                                            <img src="demo/img/gallery/thumbs/13.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/14.jpg">
                                        <div class="lightbox__item p-item">
                                            <img src="demo/img/gallery/thumbs/14.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/15.jpg">
                                        <div class="lightbox__item p-item">
                                            <img src="demo/img/gallery/thumbs/15.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/16.jpg">
                                        <div class="lightbox__item p-item">
                                            <img src="demo/img/gallery/thumbs/16.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/17.jpg">
                                        <div class="lightbox__item p-item">
                                            <img src="demo/img/gallery/thumbs/7.jpg" alt="" />
                                        </div>
                                    </div>
                        ...
                        <div class="photos-timeline">
                            <div class="photos-timeline__date c-gray text-right">
                                <span>2015</span>
                                10/07
                            </div>

                            <div class="photos-timeline__body">
                                <h2 class="photos-timeline__title">Trip to Orbit</h2>
                        ...
                        <div class="photos-timeline">
                            ...
                            <div class="photos-timeline__body">
                                <h2 class="photos-timeline__title">Purchased for print</h2>
                        ...
                        <div class="photos-timeline">
                            ...
                            <div class="photos-timeline__body">
                                <h2 class="photos-timeline__title">For Website</h2>
                        ...
                        <div class="photos-timeline">
                            ...
                            <div class="photos-timeline__body">
                                <h2 class="photos-timeline__title">To Print and Review</h2>
