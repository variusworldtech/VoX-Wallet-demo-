        ...
        <section id="main">
            <aside id="notifications">
                <ul class="tab-nav tab-nav--justified tab-nav--icon">
                    <li><a class="user-alert__messages" href="alerts.html#notifications__messages" data-toggle="tab"><i class="zmdi zmdi-email"></i></a></li>
                    <li><a class="user-alert__notifications" href="alerts.html#notifications__updates" data-toggle="tab"><i class="zmdi zmdi-notifications"></i></a></li>
                    <li><a class="user-alert__tasks" href="alerts.html#notifications__tasks" data-toggle="tab"><i class="zmdi zmdi-playlist-plus"></i></a></li>
                </ul>
                    ...
                    <ul>
                        ...
                        <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                            ...
                            <ul>
                                ...
                                <li class="navigation__active"><a href="alerts.html">Alerts</a></li>
            ...
            <section id="content">
                ...
                <div class="card">
                    ...
                    <div class="card__body">
                        ...
                        <div class="alert alert--light">What about a custom MAE styled? It's pretty neat. Isn't it?</div>
                        <div class="alert alert--dark">What about a custom MAE styled? It's pretty neat. Isn't it?</div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card__body">
                        ...
                        <div class="alert alert--dark alert-dismissible">
                            <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span></button>
                            What about a custom MAE styled? It's pretty neat. Isn't it?
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card__body">
                        ...
                        <div class="alert alert--light alert-dismissible">
                            <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span></button>
                            What about a custom MAE styled? <a href="" class="alert-link">It's pretty neat. Isn't it?</a>
                        </div>
