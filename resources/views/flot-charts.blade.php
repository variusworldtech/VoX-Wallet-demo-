        ...
        <section id="main">
            <aside id="notifications">
                <ul class="tab-nav tab-nav--justified tab-nav--icon">
                    <li><a class="user-alert__messages" href="flot-charts.html#notifications__messages" data-toggle="tab"><i class="zmdi zmdi-email"></i></a></li>
                    <li><a class="user-alert__notifications" href="flot-charts.html#notifications__updates" data-toggle="tab"><i class="zmdi zmdi-notifications"></i></a></li>
                    <li><a class="user-alert__tasks" href="flot-charts.html#notifications__tasks" data-toggle="tab"><i class="zmdi zmdi-playlist-plus"></i></a></li>
                </ul>
                ...
                <div class="navigation__menu c-overflow">
                    <ul>
                        ...
                        <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                            ...
                            <ul>
                                <li class="navigation__active"><a href="flot-charts.html">Flot Chart</a></li>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card__body">
                                <div id="chart-line" class="flot-chart"></div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card__body">
                                <div id="chart-dynamic" class="flot-chart"></div>
                            </div>
                        </div>
                    </div>
