        ...
        <section id="main">
            <aside id="notifications">
                <ul class="tab-nav tab-nav--justified tab-nav--icon">
                    <li><a class="user-alert__messages" href="photos.html#notifications__messages" data-toggle="tab"><i class="zmdi zmdi-email"></i></a></li>
                    <li><a class="user-alert__notifications" href="photos.html#notifications__updates" data-toggle="tab"><i class="zmdi zmdi-notifications"></i></a></li>
                    <li><a class="user-alert__tasks" href="photos.html#notifications__tasks" data-toggle="tab"><i class="zmdi zmdi-playlist-plus"></i></a></li>
                </ul>
                ...
                <div class="navigation__menu c-overflow">
                    <ul>
                        ...
                        <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                            ...
                            <ul>
                                <li class="navigation__active"><a href="photos.html">Default</a></li>
            ...
            <section id="content">
                ...
                <div class="card">
                    <div class="action-header">
                        <div class="action-header__label"><span class="hidden-xs">Total </span> 150 Photos</div>
                    ...
                    <div class="card__body">
                        ...
                        <div class="lightbox photos">
                            ...
                            <div data-src="demo/img/gallery/1.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/1.jpg" alt="" />
                                </div>
                            </div>

                            <div data-src="demo/img/gallery/2.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/2.jpg" alt="" />
                                </div>
                            </div>

                            <div data-src="demo/img/gallery/3.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/3.jpg" alt="" />
                                </div>
                            </div>

                            <div data-src="demo/img/gallery/4.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/4.jpg" alt="" />
                                </div>
                            </div>

                            <div data-src="demo/img/gallery/5.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/5.jpg" alt="" />
                                </div>
                            </div>
                            <div data-src="demo/img/gallery/6.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/6.jpg" alt="" />
                                </div>
                            </div>
                            <div data-src="demo/img/gallery/7.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/7.jpg" alt="" />
                                </div>
                            </div>
                            <div data-src="demo/img/gallery/8.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/8.jpg" alt="" />
                                </div>
                            </div>
                            <div data-src="demo/img/gallery/9.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/9.jpg" alt="" />
                                </div>
                            </div>
                            <div data-src="demo/img/gallery/10.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/10.jpg" alt="" />
                                </div>
                            </div>
                            <div data-src="demo/img/gallery/11.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/11.jpg" alt="" />
                                </div>
                            </div>
                            <div data-src="demo/img/gallery/12.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/12.jpg" alt="" />
                                </div>
                            </div>
                            <div data-src="demo/img/gallery/13.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/13.jpg" alt="" />
                                </div>
                            </div>
                            <div data-src="demo/img/gallery/14.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/14.jpg" alt="" />
                                </div>
                            </div>
                            <div data-src="demo/img/gallery/15.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/15.jpg" alt="" />
                                </div>
                            </div>
                            <div data-src="demo/img/gallery/16.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/16.jpg" alt="" />
                                </div>
                            </div>
                            <div data-src="demo/img/gallery/17.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/7.jpg" alt="" />
                                </div>
                            </div>
                            <div data-src="demo/img/gallery/18.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/18.jpg" alt="" />
                                </div>
                            </div>
                            <div data-src="demo/img/gallery/19.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/19.jpg" alt="" />
                                </div>
                            </div>
                            <div data-src="demo/img/gallery/20.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/20.jpg" alt="" />
                                </div>
                            </div>
                            <div data-src="demo/img/gallery/21.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/21.jpg" alt="" />
                                </div>
                            </div>
                            <div data-src="demo/img/gallery/22.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/22.jpg" alt="" />
                                </div>
                            </div>
                            <div data-src="demo/img/gallery/23.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
                                    <img src="demo/img/gallery/thumbs/23.jpg" alt="" />
                                </div>
                            </div>
                            <div data-src="demo/img/gallery/24.jpg" class="col-md-2 col-sm-4 col-xs-6">
                                <div class="lightbox__item p-item">
