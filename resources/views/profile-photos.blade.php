        ...
        <section id="main">
            <aside id="notifications">
                <ul class="tab-nav tab-nav--justified tab-nav--icon">
                    <li><a class="user-alert__messages" href="profile-photos.html#notifications__messages" data-toggle="tab"><i class="zmdi zmdi-email"></i></a></li>
                    <li><a class="user-alert__notifications" href="profile-photos.html#notifications__updates" data-toggle="tab"><i class="zmdi zmdi-notifications"></i></a></li>
                    <li><a class="user-alert__tasks" href="profile-photos.html#notifications__tasks" data-toggle="tab"><i class="zmdi zmdi-playlist-plus"></i></a></li>
                </ul>
                    ...
                    <div class="card">
                        <div class="action-header action-header--card">
                            <ul class="action-header__menu">
                                ...
                                <li class="active"><a href="profile-photos.html">Photos</a></li>
                        ...
                        <div class="card__body">
                            ...
                            <div class="photos photos--profile">
                                <div class="lightbox">
                                    ...
                                    <div data-src="demo/img/gallery/13.jpg" class="col-md-2 col-sm-3 col-xs-4">
                                        <div class="lightbox__item">
                                            <img src="demo/img/gallery/thumbs/13.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/14.jpg" class="col-md-2 col-sm-3 col-xs-4">
                                        <div class="lightbox__item">
                                            <img src="demo/img/gallery/thumbs/14.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/15.jpg" class="col-md-2 col-sm-3 col-xs-4">
                                        <div class="lightbox__item">
                                            <img src="demo/img/gallery/thumbs/15.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/16.jpg" class="col-md-2 col-sm-3 col-xs-4">
                                        <div class="lightbox__item">
                                            <img src="demo/img/gallery/thumbs/16.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/17.jpg" class="col-md-2 col-sm-3 col-xs-4">
                                        <div class="lightbox__item">
                                            <img src="demo/img/gallery/thumbs/7.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/18.jpg" class="col-md-2 col-sm-3 col-xs-4">
                                        <div class="lightbox__item">
                                            <img src="demo/img/gallery/thumbs/18.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/19.jpg" class="col-md-2 col-sm-3 col-xs-4">
                                        <div class="lightbox__item">
                                            <img src="demo/img/gallery/thumbs/19.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/20.jpg" class="col-md-2 col-sm-3 col-xs-4">
                                        <div class="lightbox__item">
                                            <img src="demo/img/gallery/thumbs/20.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/21.jpg" class="col-md-2 col-sm-3 col-xs-4">
                                        <div class="lightbox__item">
                                            <img src="demo/img/gallery/thumbs/21.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/22.jpg" class="col-md-2 col-sm-3 col-xs-4">
                                        <div class="lightbox__item">
                                            <img src="demo/img/gallery/thumbs/22.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/23.jpg" class="col-md-2 col-sm-3 col-xs-4">
                                        <div class="lightbox__item">
                                            <img src="demo/img/gallery/thumbs/23.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div data-src="demo/img/gallery/24.jpg" class="col-md-2 col-sm-3 col-xs-4">
                                        <div class="lightbox__item">
