        ...
        <section id="main">
            <aside id="notifications">
                <ul class="tab-nav tab-nav--justified tab-nav--icon">
                    <li><a class="user-alert__messages" href="tables.html#notifications__messages" data-toggle="tab"><i class="zmdi zmdi-email"></i></a></li>
                    <li><a class="user-alert__notifications" href="tables.html#notifications__updates" data-toggle="tab"><i class="zmdi zmdi-notifications"></i></a></li>
                    <li><a class="user-alert__tasks" href="tables.html#notifications__tasks" data-toggle="tab"><i class="zmdi zmdi-playlist-plus"></i></a></li>
                </ul>
                ...
                <div class="navigation__menu c-overflow">
                    <ul>
                        ...
                        <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                            ...
                            <ul>
                                <li class="navigation__active"><a href="tables.html">Normal Tables</a></li>
            ...
            <section id="content">
                ...
                <div class="card">
                    <div class="card__header">
                        <h2>Bordered table <small>Tables with borders on all possible sides of the Table and Cells</small></h2>
                    </div>
                ...
                <div class="card">
                    <div class="card__header">
                        <h2>Table Condensed <small>Make tables more compact by cutting cell padding in half.</small></h2>
                    </div>
