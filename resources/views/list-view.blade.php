        ...
        <section id="main">
            <aside id="notifications">
                <ul class="tab-nav tab-nav--justified tab-nav--icon">
                    <li><a class="user-alert__messages" href="list-view.html#notifications__messages" data-toggle="tab"><i class="zmdi zmdi-email"></i></a></li>
                    <li><a class="user-alert__notifications" href="list-view.html#notifications__updates" data-toggle="tab"><i class="zmdi zmdi-notifications"></i></a></li>
                    <li><a class="user-alert__tasks" href="list-view.html#notifications__tasks" data-toggle="tab"><i class="zmdi zmdi-playlist-plus"></i></a></li>
                </ul>
                    ...
                    <ul>
                        ...
                        <li class="navigation__sub navigation__sub--active navigation__sub--toggled">
                            ...
                            <ul>
                                ...
                                <li class="navigation__active"><a href="list-view.html">List View</a></li>
                ...
                <div class="content--boxed">
                    ...
                    <div class="card">
                        <div class="action-header">
                            <div class="action-header__label"><span class="hidden-xs">Total </span>150 Listings</div>
                            ...
                            <div class="actions action-header__actions">
                                ...
                                <a href=""><i class="zmdi zmdi-info"></i></a>
                        ...
                        <div class="list-group list-group--striped">
                            <div class="list-group-item media">
                                <div class="checkbox pull-left list-group__checkbox list-group__checkbox">
                                    <label>
                                        <input type="checkbox">
                                ...
                                <div class="media-body">
                                    <div class="list-group__heading">Per an error perpetua, fierent fastidii recteque ad pro. Mei id brute intellegam</div>
                                    <small class="list-group__text">Quisque non tortor ultricies, posuere elit id, lacinia purus curabitur.</small>
                                </div>
                            </div>

                            <div class="list-group-item media">
                                <div class="checkbox pull-left list-group__checkbox">
                                    <label>
                                        <input type="checkbox">
                                        <i class="input-helper"></i>
                                    </label>
                                ...
                                <div class="pull-left">
                                    <div class="avatar-char">D</div>
                                </div>

                                <div class="media-body">
                                    <div class="list-group__heading">Dulla vel metus scelerisque ante sollicitudin commodo purus odio</div>
                                    <small class="list-group__text">Nunc quis diam diamurabitur at dolor elementum, dictum turpis vel</small>
                                </div>
                            </div>
                            ...
                            <div class="list-group-item media">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="list-group__attrs">
                                        <div>Date Created: 09/06/1988</div>
                                        <div>Members: 78954</div>
                                        <div>Published: No</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="list-group-item media">
                                ...
                                <div class="media-body">
                                    <div class="list-group__heading">Donec congue tempus ligula, varius hendrerit mi hendrerit sit amet. Duis ac quam sit amet leo feugiat iaculis</div>
                                    <small class="list-group__text">An erant explicari salutatus duo, sumo doming delicata in cum. Eos at augue viderer principes</small>
                            ...
                            <div class="list-group-item media">
                                ...
                                <div class="media-body">
                                    <div class="list-group__heading">Per an error perpetua, fierent fastidii recteque ad pro. Mei id brute intellegam</div>
                                    <small class="list-group__text">Phasellus a ante et est ornare accumsan at vel magnauis blandit turpis at augue ultricies</small>
                                </div>
                            </div>
                            ...
                            <div class="list-group-item media">
                                ...
                                <div class="media-body">
                                    <div class="list-group__heading">Wel ea elit iuvaret. Mea labitur definitiones ex, id atqui accusata vix, vim nibh mandamus ad</div>
                                    <small class="list-group__text">Wendy create ipsum dolor sit amet, per cu solet docendi ntoenstion</small>
                            ...
                            <div class="list-group-item media">
                                ...
                                <div class="media-body">
                                    ...
                                    <span class="list-group__attrs">
                                        <span>Date Created: 11/06/1988</span>
                                        <span>Members: 212</span>
